...
//
// Inert in Electron: applySeo() returns immediately under file://, so the
// packaged app never touches its own <head>.
 ...
 * it only ever mutates tags it owns. No-op outside the web build.
 */
